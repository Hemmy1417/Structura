...
const M = [
  ...
  ["acts", "the cover features an unjudged milestone", `!!m.standing && m.rounds_count > 0`, `!!m.standing`],
  ["acts", "the cover features one no decision stands on", `!!m.standing && m.rounds_count > 0`, `m.rounds_count > 0`],
  ["acts", "the cover ignores which example was paid", `decided.find((m) => m.state === "FINALIZED")`, `decided.find((m) => m.state === "NEVER")`],
